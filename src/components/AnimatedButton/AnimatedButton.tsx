...
export const AnimatedButton: React.FC<AnimatedButtonProps> = ({ text, icon, onClick }) => {
  return (
    <motion.button
      ...
      onClick={onClick}
    >
      <div className="relative px-3 py-2 bg-gradient-to-r from-indigo-600 via-purple-600 to-pink-600 rounded-2xl transform transition-all duration-500 ease-out group-hover:translate-z-10 group-hover:rotate-y-12 shadow-2xl min-w-[100px]">
        ...
        <motion.div
          className="absolute -inset-2 border-2 border-purple-300/30 rounded-2xl"
          animate={{
            scale: [1, 1.05, 1],
            opacity: [0.3, 0.5, 0.3],
          }}
